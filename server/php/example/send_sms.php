 ...
 * The messages are sent the next time fondaSMS sends an ACTION_OUTGOING request to www/gateway.php.
 */

require_once __DIR__."/config.php";
require_once dirname(__DIR__)."/fondaSMS.php";
...
$message = new fondaSMS_OutgoingMessage();
$message->id = uniqid("");
$message->to = $to;
