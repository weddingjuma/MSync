PHP server library for fondaSMS, with example implementation

The fondaSMS.php library is intended to be used as part of a PHP application
running on an HTTP server that receives incoming SMS messages from, and sends
outgoing SMS messages to, an Android phone running fondaSMS.
...
example/config.php contains the password for a phone running fondaSMS. The password
...
On a phone running fondaSMS, go to Menu -> Settings and enter:
...
example/www/test.html allows you to simulate the HTTP requests made by fondaSMS
in your browser without actually using the fondaSMS app.
If you're using server.php, just go to http://<your_ip_address>:8002/test.html

See fondaSMS.php and example/www/gateway.php
