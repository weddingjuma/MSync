...
import com.deadangroup.msync.IncomingMms;
import com.deadangroup.msync.IncomingSms;
import com.deadangroup.msync.MessagingUtils;
...
public class CheckMessagingService extends IntentService
{
    ...
    private void checkNewMms()
    {
        ...
        for (IncomingMms mms : messages)
        {
            ...
            // before MSync started, or re-forwarding MMS multiple
