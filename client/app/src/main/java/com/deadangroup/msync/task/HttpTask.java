...
import com.deadangroup.msync.Base64Coder;
import com.deadangroup.msync.HttpData;
import com.deadangroup.msync.JsonUtils;
import com.deadangroup.msync.OutgoingMessage;
import com.deadangroup.msync.XmlUtils;
...
public class HttpTask extends BaseHttpTask {
    ...
    protected HttpData doInBackground(String... ignored) {
        ...
        params.add(new BasicNameValuePair("phone_secret", app.getPassword()));
