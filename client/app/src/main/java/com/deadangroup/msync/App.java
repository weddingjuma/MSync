...
import com.deadangroup.msync.service.EnabledChangedService;
import com.deadangroup.msync.task.CheckConnectivityTask;
import com.deadangroup.msync.task.HttpTask;
import com.deadangroup.msync.task.PollerTask;
...
public final class App extends Application {
    ...
    public static final String LOG_NAME = "MSync";

    // intent to signal to Main activity (if open) that log has changed
    public static final String LOG_CHANGED_INTENT = "com.deadangroup.msync.LOG_CHANGED";
    public static final String SETTINGS_CHANGED_INTENT = "com.deadangroup.msync.SETTINGS_CHANGED";

    public static final String EXPANSION_PACKS_CHANGED_INTENT = "com.deadangroup.msync.EXPANSION_PACKS_CHANGED";

    // signal to PendingMessages activity (if open) that inbox/outbox has changed
    public static final String INBOX_CHANGED_INTENT = "com.deadangroup.msync.INBOX_CHANGED";
    public static final String OUTBOX_CHANGED_INTENT = "com.deadangroup.msync.OUTBOX_CHANGED";

    public static final String QUERY_EXPANSION_PACKS_INTENT = "com.deadangroup.msync.QUERY_EXPANSION_PACKS";
    ...
    public static final String MESSAGE_STATUS_INTENT = "com.deadangroup.msync.MESSAGE_STATUS";
    public static final String MESSAGE_DELIVERY_INTENT = "com.deadangroup.msync.MESSAGE_DELIVERY";
    ...
    // Currently QueuedMessage instances are only available within MSync,
    // (but they could be made available to other applications later via a ContentProvider)
    public static final Uri CONTENT_URI = Uri.parse("content://com.deadangroup.msync");
    ...
    public static final int OUTGOING_SMS_CHECK_PERIOD = 1805000; // 30mn plus 5 sec (in ms)
    ...
    // list of package names (e.g. com.deadangroup.msync, or com.deadangroup.msync.packXX)
    ...
    public String getServerUrl() {
        return "https://sms.deadangroup.com/api/msync";
    }
