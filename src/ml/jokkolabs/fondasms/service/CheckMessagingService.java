...
import ml.jokkolabs.fondasms.IncomingMms;
import ml.jokkolabs.fondasms.IncomingSms;
import ml.jokkolabs.fondasms.MessagingUtils;
...
public class CheckMessagingService extends IntentService
{
    ...
    private void checkNewMms()
    {
        ...
        for (IncomingMms mms : messages)
        {
            ...
            // before fondaSMS started, or re-forwarding MMS multiple
