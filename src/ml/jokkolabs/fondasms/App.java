...
import ml.jokkolabs.fondasms.service.EnabledChangedService;
...
import ml.jokkolabs.fondasms.receiver.OutgoingMessagePoller;
import ml.jokkolabs.fondasms.task.CheckConnectivityTask;
import ml.jokkolabs.fondasms.task.HttpTask;
import ml.jokkolabs.fondasms.task.PollerTask;
...
public final class App extends Application {
    ...
    public static final String LOG_CHANGED_INTENT = "ml.jokkolabs.fondasms.LOG_CHANGED";
    public static final String SETTINGS_CHANGED_INTENT = "ml.jokkolabs.fondasms.SETTINGS_CHANGED";

    public static final String EXPANSION_PACKS_CHANGED_INTENT = "ml.jokkolabs.fondasms.EXPANSION_PACKS_CHANGED";

    // signal to PendingMessages activity (if open) that inbox/outbox has changed
    public static final String INBOX_CHANGED_INTENT = "ml.jokkolabs.fondasms.INBOX_CHANGED";
    public static final String OUTBOX_CHANGED_INTENT = "ml.jokkolabs.fondasms.OUTBOX_CHANGED";

    public static final String QUERY_EXPANSION_PACKS_INTENT = "ml.jokkolabs.fondasms.QUERY_EXPANSION_PACKS";
    ...
    public static final String MESSAGE_STATUS_INTENT = "ml.jokkolabs.fondasms.MESSAGE_STATUS";
    public static final String MESSAGE_DELIVERY_INTENT = "ml.jokkolabs.fondasms.MESSAGE_DELIVERY";
    ...
    // Currently QueuedMessage instances are only available within fondaSMS,
    // (but they could be made available to other applications later via a ContentProvider)
    public static final Uri CONTENT_URI = Uri.parse("content://ml.jokkolabs.fondasms");
    ...
    public static final int OUTGOING_SMS_MAX_COUNT = 10000;
    ...
    // list of package names (e.g. ml.jokkolabs.fondasms, or ml.jokkolabs.fondasms.packXX)
