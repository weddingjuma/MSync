...
public final class App extends Application {
    ...
    public static final String LOG_CHANGED_INTENT = "com.yeleman.fondasms.LOG_CHANGED";
    public static final String SETTINGS_CHANGED_INTENT = "com.yeleman.fondasms.SETTINGS_CHANGED";

    public static final String EXPANSION_PACKS_CHANGED_INTENT = "com.yeleman.fondasms.EXPANSION_PACKS_CHANGED";

    // signal to PendingMessages activity (if open) that inbox/outbox has changed
    public static final String INBOX_CHANGED_INTENT = "com.yeleman.fondasms.INBOX_CHANGED";
    public static final String OUTBOX_CHANGED_INTENT = "com.yeleman.fondasms.OUTBOX_CHANGED";
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://com.yeleman.fondasms");
    ...
    // list of package names (e.g. com.yeleman.fondasms, or com.yeleman.fondasms.packXX)
